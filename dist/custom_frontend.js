				...
				(n.prototype = {
					...
					_getCell: function(t, i) {
						...
						switch (i) {
							...
							case "day":
								h +=
									'[data-month="' + a.month + '"][data-date="' + a.date + '"]';
						}
						return (
					...
					$(f).on("submit", function(event) {
						if (
							...
							if (!field_parent.find(".cwp-error").length) {
								...
								field_parent.append(
									'<label class="cwp-error">This field is required.</label>'
								);
							}
						} else {
							$(this).submit();
