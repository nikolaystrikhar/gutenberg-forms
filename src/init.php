 ...
 * @since 1.0.0
 */
function gutenberg_forms_cgb_block_assets() { // phpcs:ignore
	// Register block styles for both frontend + backend.
	wp_register_style(
		'gutenberg_forms-cgb-style-css', // Handle.
	...
	wp_register_script(
		'gutenberg_forms-cgb-block-js', // Handle.
	...
	wp_register_style(
		'gutenberg_forms-cgb-block-editor-css', // Handle.
