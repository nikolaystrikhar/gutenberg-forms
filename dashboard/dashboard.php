...
class Dashboard {
		...
		add_action(
			...
			function ( $suffix ) {
				...
				wp_enqueue_script(
					...
					plugins_url( '/', __DIR__ ) . '/dist/dashboard/index.js',
					array(
						'wp-api',
						'wp-i18n',
						'wp-components',
					...
					filemtime( plugin_dir_path( __DIR__ ) . '/dist/dashboard/index.js' ),
					true
				);

				wp_enqueue_style(
					'cwp_gf_dashboard_style',
					plugins_url( '/', __DIR__ ) . '/dist/dashboard/style-index.css',
					array( 'wp-components' ),
					filemtime( plugin_dir_path( __DIR__ ) . '/dist/dashboard/style-index.css' )
				);
	...
	public function add_menu() {
		...
		add_submenu_page(
			...
			'Entries',
			self::capability,
			'admin.php?page=gutenberg_forms#/entries'
		);
